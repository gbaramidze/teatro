      ...
      <div className="container">
          ...
          <div className="col-lg-4">
            <Card className="text-center mt-4">
              <Card.Body>
                ...
                <Card.Title className="fw-bold" style={{fontSize: 33}}>
                  contact@teatro.ge
                </Card.Title>
                <Card.Subtitle>{t("Tech support")}</Card.Subtitle>
              </Card.Body>
            </Card>
          </div>
          <div className="col-lg-4">
            <Card className="text-center mt-4">
              <Card.Body>
                ...
                <Card.Subtitle>{t("Manager's email")}</Card.Subtitle>
              </Card.Body>
            </Card>
          </div>
          <div className="col-lg-4">
            <Card className="text-center mt-4">
              <Card.Body>
                ...
                <Card.Subtitle>{t("Phone")}</Card.Subtitle>
              </Card.Body>
            </Card>
          </div>
        </div>
        <div>
          <Button
            ...
            target="_blank"
            href="https://wa.me/+995598254444"
          >
            <BsWhatsapp/> {t("Chat with us")}
          </Button>
        </div>
      </div>
    </section>
