                ...
                <div className="row gx-20 gy-50 gy-lg-0 align-items-center justify-content-between">
                    ...
                    <div className="col-lg-6 order-lg-1">
                        <div className="blog-left-content">
                            ...
                            <div>
                                <Link href={`/event/${id}`} className="download-link d-flex align-items-center gap-30" aria-label="buttons">Buy tickets <TopUpArrow className={"ticket-arrow"} height={"32"} width={"32"}/> </Link>
                            </div>
                        </div>
                        {/* -- left-content -- */}
                    </div>
