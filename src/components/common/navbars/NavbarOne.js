                      ...
                      menuList.map(({id, isDropdown, name, path}) => {
                        return (
                          <li key={id}
                            ...
                            <Link
                              className={`nav-link ${isDropdown && "dropdown-toggle"} d-flex align-items-end gap-0 flex-column text-uppercase`}
                              href={path} aria-label="nav-links" data-bs-toggle={`${isDropdown && "dropdown"}`}>
